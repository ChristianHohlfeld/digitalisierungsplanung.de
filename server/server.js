...
function writeHtml(response, statusCode, body, headers = {}) {
  response.writeHead(statusCode, {
    ...
    "cache-control": "no-store",
    "content-security-policy": "default-src 'none'; connect-src 'self'; script-src 'unsafe-inline'; style-src 'unsafe-inline' https://cdn.jsdelivr.net; base-uri 'none'; form-action 'none'; frame-ancestors 'none'",
