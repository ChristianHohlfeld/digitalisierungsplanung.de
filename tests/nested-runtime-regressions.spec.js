...
function nestedCompositeModel() {
  return {
    ...
    states: [
      ...
      { id: "state_3", title: "State 3", body: "", components: [], data: {}, parentId: "state_2", x: 360, y: 168, boundary: { entryId: "state_4", exitId: "state_4", entryDisabled: false, exitDisabled: false } },
